...
frappe.query_reports["Monthly Attendance Sheet Employees"] = {
	filters: [
		{
			fieldname: "month",
			label: __("Month"),
	...
	onload: function (report) {
		return frappe.call({
			method: "chundakadan.chundakadan.report.monthly_attendance_sheet_employees.monthly_attendance_sheet_employees.get_attendance_years",
			callback: function (r) {
				var year_filter = frappe.query_report.get_filter("year");
				year_filter.df.options = r.message;
				year_filter.df.default = r.message.split("\n")[0];
				year_filter.refresh();
				year_filter.set_value(year_filter.df.default);
			},
		});
	},
