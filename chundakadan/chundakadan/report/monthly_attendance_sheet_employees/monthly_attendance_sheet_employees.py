...
def get_attendance_status_for_detailed_view(
	...
	Original behavior created one row per shift which led to separate rows for
	different attendance statuses when an employee had records under different shifts.
	"""
	total_days = get_total_days_in_month(filters)
	row = {"shift": ""}
