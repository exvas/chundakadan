...
#     # Priority check: Is this user the explicitly designated approver?
#     # This ensures that even if designation lookup fails (e.g. for generic 'Pending' status),
#     # the person named in the document can still act on it.
...
#     return {"can_approve": False, "reason": "No matching designation and not the designated approver"}
